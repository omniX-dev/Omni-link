...
```go
import "github.com/omniX-dev/Omni-link/executor/text"
...
`github.com/omniX-dev/Omni-link/executor/text` — text executor
`github.com/omniX-dev/Omni-link/executor/image` — image executor
`github.com/omniX-dev/Omni-link/executor/audio` — audio executor
`github.com/omniX-dev/Omni-link/executor/video` — video executor
