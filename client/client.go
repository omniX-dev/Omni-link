...
//
//	import (
//		_ "github.com/omniX-dev/Omni-link/executor/text/openai"
//		_ "github.com/omniX-dev/Omni-link/executor/text/anthropic"
//		_ "github.com/omniX-dev/Omni-link/executor/image/openai"
//	)
//
// Only imported executors are compiled into the binary — true on-demand loading.
// For all executors, import:
//
//	import _ "github.com/omniX-dev/Omni-link/executor/all"
package client
...
import (
	...
	"github.com/omniX-dev/Omni-link/executor/audio"
	audioexec "github.com/omniX-dev/Omni-link/executor/audio"
	"github.com/omniX-dev/Omni-link/executor/image"
	imageexec "github.com/omniX-dev/Omni-link/executor/image"
	textexec "github.com/omniX-dev/Omni-link/executor/text"
	"github.com/omniX-dev/Omni-link/executor/video"
	videoexec "github.com/omniX-dev/Omni-link/executor/video"
	"github.com/omniX-dev/Omni-link/executor/embedding"
	embeddingexec "github.com/omniX-dev/Omni-link/executor/embedding"
	"github.com/omniX-dev/Omni-link/model"
